...
engine = sqlalchemy.create_engine('postgresql://postgres:Mahay2004@localhost:5433/is303')

bMenuLoop = True

while bMenuLoop == True :
    ...
    if user_input == '1':
        ...
        for url in talk_urls :
            ...
            if 'sustain' in current_talk['Talk_Name'].lower():
                continue
            if 'auditing' in current_talk['Talk_Name'].lower():
                continue
